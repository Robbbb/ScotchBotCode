...
#define READ_INTERVAL 500 // time between reads

#define PLAYBACK_INTERVAL 500 // time between reads
...
int lastRecordButtonState = HIGH;   // the previous reading from the input pin
...
void setup()
{
  ...
  digitalWrite(RECORD_BUTTON_PIN, HIGH);
      ...
      for(int i = 1; i <= SERVOCOUNT; i++)
      {
        ...
        while(readTries < MAX_READ_TRIES && currentReadPosition == -1)
        {
          ...
          if(currentReadPosition > 1023 ||  currentReadPosition < 0)//why do these show up as 1793 occassionally?
          {
            ...
            Serial.print("Servo ");
            Serial.print(i);
            Serial.print(" out of range. Reported position: ");
            Serial.print(currentReadPosition);
            Serial.print(" attempt # ");
            Serial.println(readTries);
            ////////////////kill error/////currentReadPosition = -1;
          }
