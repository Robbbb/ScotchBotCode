...
PROGMEM prog_uint16_t spi#ifndef REBOLT_R5_POSES
#define REBOLT_R5_POSES
...
PROGMEM transition_t sleep[] = {{0,2} ,{spinnable_mid,5000} ,{SLEEP,5000} };
...
PROGMEM transition_t toPour[] = {{0,16} ,{fill_wait,5000} {pre_fill,5000} ,{spinnable_fill,5000} ,{spinnable_mid,5000} ,{smell_0,5000} ,{smell_45,5000} ,{smell_PLUS45,5000} ,{spinnable_near_pour,5000} ,{pour_0,5000} ,{pour_45,5000} ,{pour_110,5000} ,{pour_135,5000} ,{pour_45,5000} ,{pour_0,5000} ,{spinnable_near_pour,5000} ,{CENTER,5000} };


#endif
nable_mid[] = {7, 517, 508, 512, 311, 704, 711, 512};
PROGMEM prog_uint16_t smell_0[] = {7, 485, 403, 617, 699, 314, 135, 510};
